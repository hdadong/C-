...
using namespace std;
#ifdef _WIN64
#pragma comment(lib,"D:/C++/语音识别2/libs/msc_x64.lib") //x64
#else
#pragma comment(lib,"D:/C++/语音识别2/libs/msc.lib") //x86
#endif
...
int main(int argc, char* argv[])
{
	...
	const char* login_params = "appid = 5bd45cb7, work_dir = ."; // 登录参数，appid与msc库绑定,请勿随意改动
	...
	*/
	...
	run_iat("D:/C++/语音识别2/语音识别2/sb82.wav", session_begin_params); //iflytek02音频内容为“中美数控”；如果上传了用户词表，识别结果为：“中美速控”。
exit:
	printf("按任意键退出 ...\n");
	_getch();
	MSPLogout(); //退出登录
